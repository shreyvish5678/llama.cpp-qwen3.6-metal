...
> twice. Details: **[QWEN36-METAL.md](QWEN36-METAL.md)** — named for Qwen3.6, which is what this fork
> measured until 2026-08-14. Branch `shipped` is the tuned stack; `master` is the upstream commit it
> forks from.
